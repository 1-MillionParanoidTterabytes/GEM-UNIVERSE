...
Please, feel free to click on the Next button, and get started.";
	...
	{
		return System.IO.Path.Combine(BoltPathUtility.PackagesPath, packageName + ".unitypackage");
	}
	...
	{
		return System.IO.File.Exists(System.IO.Path.Combine(BoltPathUtility.ScriptsPath, "BoltLauncher.cs"));
	}
	...
	void InitialSetup()
	{
		string SETTINGS_PATH = System.IO.Path.Combine(BoltPathUtility.ResourcesPath, "BoltRuntimeSettings.asset");
		string PREFABDB_PATH = System.IO.Path.Combine(BoltPathUtility.ResourcesPath, "BoltPrefabDatabase.asset");
